...
class Auth extends CI_Controller
{
    ...
    {
        $config = [
            'protocol'  => 'smtp', // ✅ bukan smpt
            'smtp_host' => 'ssl://smtp.googlemail.com', // ✅ bukan smpt.googlemail.com
            'smtp_user' => 'notnai66@gmail.com',
            'smtp_pass' => 'znek ouph pqid fsww', // ✅ ini App Password dari Gmail
            'smtp_port' => 465, // ✅ bukan smpt_port
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ];
        ...
        $this->email->initialize($config); // ✅ tambahkan ini agar konfigurasi terpasang dengan benar

        $this->email->from('notnai66@gmail.com', 'not nai');
        ...
        if($type == 'verify') {
           ...
           $this->email->message('Click this link to verify your account: 
            ...
            . urlencode($this->input->post('email')) 
